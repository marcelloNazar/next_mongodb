  ...
  if (session.status === "authenticated") {
    return (
      <div className="page-container h-[93%]">
        ...
        <div className="w-full h-full relative overflow-x-hidden shadow-md rounded-bl-lg lg:rounded-l-lg">
          <table className="w-full h-full text-sm text-left text-gray-500 dark:text-gray-400 ">
            <thead className="text-xs text-gray-700 uppercase dark:text-gray-400">
              <tr>
                <th
                  scope="col"
                  className="px-6 py-3 w-[28%] bg-gray-200 dark:bg-gray-800/50"
                >
                  Titulo
                </th>
                ...
                <th
                  scope="col"
                  className="px-6 py-3 bg-gray-200 dark:bg-gray-800/50"
                >
                  Data
                </th>
                ...
                <th
                  scope="col"
                  className="px-6 py-3  bg-gray-200 dark:bg-gray-800/50  w-[19%]"
                >
                  Valor
                </th>
              ...
              {data
                ...
                .map((teste: IFinance) => (
                  ...
                  >
                    <th
                      scope="row"
                      className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-200 dark:text-white dark:bg-gray-800/40"
                    >
                    ...
                    <td className="px-6 py-4 bg-gray-200 dark:bg-gray-800/40">
            ...
            <tfoot className="h-full rounded-md">
              <tr className="font-semibold text-gray-900 dark:text-white">
                <th className="px-6 py-3 bg-gray-200 dark:bg-gray-800/40"></th>
                <td className="px-6 py-3"></td>
                <td className="px-6 py-3 bg-gray-200 dark:bg-gray-800/40"></td>
                <td className="px-6 py-3"></td>
                <td className="px-6 py-3 bg-gray-200 dark:bg-gray-800/40"></td>
              </tr>
            </tfoot>
        ...
        <div className="flex flex-row lg:flex-col h-[300px] lg:h-[100%] gap-2 w-full lg:w-1/3">
          ...
          <div
            ...
            className="flex text-xs justify-start p-2 pt-3 gap-1 items-center flex-col w-[31%] lg:w-full bg-gray-200 dark:bg-gray-800/40 shadow-md rounded-tl-lg lg:rounded-tl-none  lg:rounded-tr-lg"
          >
          ...
          <div className="flex flex-col w-[28%] lg:h-full lg:w-full">
            <div className="flex justify-between p-4 items-center w-full h-1/3 bg-gray-200 dark:bg-gray-800/40 shadow-md rounded-tr-lg lg:rounded-none">
              <h1>Rec:</h1>
            ...
            <div className="flex justify-between p-4 items-center w-full h-1/3 bg-gray-200 dark:bg-gray-800/40 shadow-md lg:rounded-br-lg">
              <h1>Sal:</h1>
